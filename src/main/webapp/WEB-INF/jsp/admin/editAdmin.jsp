...
<form class="layui-form" style="width: 80%;">
    ...
    <input type="hidden" name="id" value="${modifyAdmin.id}"/>
    <div class="layui-form-item">
        <label class="layui-form-label ">用户名</label>
        <div class="layui-input-block">
            <input type="text" id="username" class="layui-input"
                   lay-verify="required" placeholder="请输入用户名" name="username" value="${modifyAdmin.username}">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="nickname" id="nickname" class="layui-input"
                   lay-verify="required" placeholder="请输入昵称" value="${modifyAdmin.nickname}">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="email" id="email" class="layui-input"
                   lay-verify="email" placeholder="请输入邮箱" value="${modifyAdmin.email}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <c:if test="${modifyAdmin.sex=='女'}">
                <input type="radio" name="sex" value="男" title="男">
                <input type="radio" name="sex" value="女" title="女" checked>
            </c:if>
            <c:if test="${modifyAdmin.sex=='男'}">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="phone" class="layui-input"
                   lay-verify="phone" placeholder="请输入手机号" value="${modifyAdmin.phone}">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="roleId">
                ...
                <c:forEach items="${roles}" var="r">
                    <c:if test="${modifyAdmin.roleId==r.id}">
